...
class GeminiCompanyResearcher:
    ...
    def __init__(self, api_key: Optional[str] = None, timeout: int = 90):
        ...
        self.timeout = timeout  # Timeout in seconds (default 90s)
    ...
    def perform_research(self, company_query: str, domain: Optional[str] = None) -> Dict[str, Any]:
        ...
        Includes timeout protection for stuck requests (90 seconds default).
        """
...
if __name__ == "__main__":
    try:
        ...
        # You can customize timeout here (default is 90 seconds)
        outcome = run_research_task(target_company, target_domain, timeout=90)
