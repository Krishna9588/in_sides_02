...
class GeminiCompanyResearcher:
    ...
    def __init__(self, api_key: Optional[str] = None):
        ...
        self.api_key = "AIzaSyBXvXe0g1H7gxLI2rpGasBsaBohw3dkW6s"
        ...
        # self.model2 = "gemini-2.5-flash"
        # self.model3 = "gemini-2.5-flash-lite"
    ...
    def perform_research(self, company_query: str, domain: Optional[str] = None) -> Dict[str, Any]:
        ...
        # models_to_try = [self.model, self.model2, self.model3]
