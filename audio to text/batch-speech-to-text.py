...
parser.add_argument("-m", "--model", type=str, help="whisper model name or huggingface model path",
                    default='large-v3-turbo')
parser.add_argument("-l", "--language", type=str,
                    help="force recognition using this language, e.g. ru. Detected automatically if not specified")
