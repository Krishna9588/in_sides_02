...
def extract_crunchbase_info(html_content):
    ...
    def extract_data(pattern, text=json_text, default=None):
        ...
        return re_match.group(1) if re_match else default
    ...
    if location_data := extract_data(
        ...
        for re_match in re.finditer(
            ...
            location_parts[re_match.group(1)] = re_match.group(2)
...
def main():
    ...
    # target_url = "https://www.crunchbase.com/organization/growwgroww"
    target_url = "https://www.crunchbase.com/organization/mindtickle"
    ...
    try:
        ...
        # Save as JSON
        with open("../crunchbase-data_mindtickle_1/company_data.json", "w", encoding="utf-8") as f:
